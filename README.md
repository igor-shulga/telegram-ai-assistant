...
3. В лівому меню натисни **Get API key**
4. Натисни синю кнопку **Create API key**
5. Відкриється вікно "Create API key" — в ньому є рядок **"Select a Google Cloud project"**
6. Під цим рядком натисни **"Create a new project"** (не обирай існуючий!)
7. З'явиться ключ вигляду `AIzaSy...` — натисни іконку копіювання поряд і збережи

> Чому "new project"? Кожен новий проект отримує свіжий безкоштовний ліміт: 1500 запитів на день. Якщо обрати існуючий проект у якому ліміт вже вичерпаний — бот не буде відповідати.
